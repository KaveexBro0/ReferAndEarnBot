...
3. **Configure the Bot:**
   - Open `/setup` command and replace `YOUR_TELEGRAM_ID` with your Telegram ID (e.g., `123456789`).
   ...
   - Optionally, customize properties via commands:
     ...
     /setMinWithdrawal {minWithdraw}
     /setMainChannel {@YourMainChannel}
     /setPaymentChannel {@YourPaymentChannel}
     ```
4. **Test the Bot:**
